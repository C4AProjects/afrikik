...
angular.module('nouchiapiApp')
  .controller('MainCtrl',['$scope', '$filter', '$rootScope', '$state', 'User','authenticationService','config','Global', 'ErrorHandler',function ($scope, $filter, $rootScope,$state, User, Auth, config, global, ErrorHandler) {
  	$scope.auth={
      email:'boobahsiddik10@gmail.com',
      password:'tester'
    };
