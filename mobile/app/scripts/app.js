...
var Afrikik = angular.module('Afrikik', ['ngCordova', 'jmdobry.angular-cache','ionic','openfb', 'Afrikik.services',  'config', 'angularLocalStorage','ui.router','ngResource','infinite-scroll','pascalprecht.translate','underscore', 'angular-loading-bar','ngAnimate'])
